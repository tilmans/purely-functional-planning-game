...
var _user$project$Login$extract = F3(
...
var _user$project$Login$notUser = F2(
	function (user, vote) {
		return !_elm_lang$core$Native_Utils.eq(vote.user, user);
	});
var _user$project$Login$getIdFrom = function (location) {
	var string = A2(_elm_lang$core$String$dropLeft, 1, location);
	var subs = A2(_elm_lang$core$String$split, '&', string);
	var name = A3(
		_elm_lang$core$List$foldr,
		_user$project$Login$extract('name'),
		_elm_lang$core$Maybe$Nothing,
		subs);
	var id = A3(
		_elm_lang$core$List$foldr,
		_user$project$Login$extract('room'),
		_elm_lang$core$Maybe$Nothing,
		subs);
	return {ctor: '_Tuple2', _0: name, _1: id};
};
var _user$project$Login$userParams = _elm_lang$core$Json_Encode$object(
	{
		ctor: '::',
		_0: {
			ctor: '_Tuple2',
...
var _user$project$Login$cardAssets = function (number) {
...
var _user$project$Login$vote = function (vote) {
	return A2(
...
var _user$project$Login$playedCards = function (model) {
	var _p0 = model.votes;
	if (_p0.ctor === '[]') {
		return A2(
			_elm_lang$html$Html$div,
		...
		return A2(
			...
			A2(_elm_lang$core$List$map, _user$project$Login$vote, model.votes));
	}
};
var _user$project$Login$cards = {
	ctor: '::',
	_0: 0,
	_1: {
		ctor: '::',
...
var _user$project$Login$socketServer = function (location) {
...
var _user$project$Login$Vote = F2(
	function (a, b) {
		return {user: a, vote: b};
	});
var _user$project$Login$decodeVote = A3(
	_elm_lang$core$Json_Decode$map2,
	_user$project$Login$Vote,
...
var _user$project$Login$Model = F8(
	function (a, b, c, d, e, f, g, h) {
		return {phxSocket: a, message: b, channel: c, roomID: d, played: e, name: f, votes: g, state: h};
	});
var _user$project$Login$CardSelected = function (a) {
	return {ctor: 'CardSelected', _0: a};
};
var _user$project$Login$cardImage = F3(
				...
				_1: {
					...
					_1: {
						...
						_0: _elm_lang$html$Html_Events$onClick(
							_user$project$Login$CardSelected(number)),
						_1: {ctor: '[]'}
					}
				}
			},
...
var _user$project$Login$aframeScene = function (model) {
	return A2(
		...
		A2(
			...
			A2(
				_elm_lang$core$Basics_ops['++'],
				A2(_elm_lang$core$List$map, _user$project$Login$cardAssets, _user$project$Login$cards),
				A2(
					_elm_lang$core$List$indexedMap,
					_user$project$Login$cardImage(model.played),
					_user$project$Login$cards))));
};
var _user$project$Login$ListUpdate = function (a) {
	return {ctor: 'ListUpdate', _0: a};
};
var _user$project$Login$SetName = {ctor: 'SetName'};
var _user$project$Login$UrlChange = function (a) {
	return {ctor: 'UrlChange', _0: a};
};
var _user$project$Login$NameChange = function (a) {
	return {ctor: 'NameChange', _0: a};
};
var _user$project$Login$nameform = function (model) {
	return A2(
		_elm_lang$html$Html$form,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Events$onSubmit(_user$project$Login$SetName),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				_elm_lang$html$Html$input,
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onInput(_user$project$Login$NameChange),
						_1: {
							ctor: '::',
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(_user$project$Login$SetName),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
...
var _user$project$Login$Play = function (a) {
	return {ctor: 'Play', _0: a};
};
var _user$project$Login$card = function (number) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			...
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onClick(
					_user$project$Login$Play(number)),
				_1: {ctor: '[]'}
			}
		},
		{
...
var _user$project$Login$availableCards = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
	...
	A2(_elm_lang$core$List$map, _user$project$Login$card, _user$project$Login$cards));
var _user$project$Login$gameform = function (model) {
			...
			_1: {
				...
				_0: A2(
					...
					{ctor: '[]'},
					{
						...
						_1: {
							ctor: '::',
							_0: _user$project$Login$playedCards(model),
							_1: {ctor: '[]'}
						}
					}),
				_1: {
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_1: {
								ctor: '::',
								_0: _user$project$Login$availableCards,
								_1: {ctor: '[]'}
							}
						}),
					_1: {ctor: '[]'}
...
var _user$project$Login$NewRoom = function (a) {
	return {ctor: 'NewRoom', _0: a};
};
var _user$project$Login$RoomIDChanged = function (a) {
	return {ctor: 'RoomIDChanged', _0: a};
};
var _user$project$Login$CreateRoom = {ctor: 'CreateRoom'};
var _user$project$Login$JoinRoom = {ctor: 'JoinRoom'};
var _user$project$Login$startform = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						_elm_lang$html$Html$input,
						{
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onInput(_user$project$Login$RoomIDChanged),
								_1: {ctor: '[]'}
							}
						},
						{ctor: '[]'}),
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(_user$project$Login$JoinRoom),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
				...
				_0: A2(
					...
					{ctor: '[]'},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(_user$project$Login$CreateRoom),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
...
var _user$project$Login$view = function (model) {
	...
	switch (_p3.ctor) {
		case 'NameInput':
			return _user$project$Login$nameform(model);
		case 'RoomInput':
			return _user$project$Login$startform(model);
		default:
			return _user$project$Login$aframeScene(model);
	}
};
var _user$project$Login$VoteFromServer = function (a) {
	return {ctor: 'VoteFromServer', _0: a};
};
var _user$project$Login$ShowJoinMessage = function (a) {
	return {ctor: 'ShowJoinMessage', _0: a};
};
var _user$project$Login$ShowLeaveMessage = function (a) {
	return {ctor: 'ShowLeaveMessage', _0: a};
};
var _user$project$Login$PhoenixMsg = function (a) {
	return {ctor: 'PhoenixMsg', _0: a};
};
var _user$project$Login$subscriptions = function (model) {
	return A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$listen, model.phxSocket, _user$project$Login$PhoenixMsg);
};
var _user$project$Login$play = function (model) {
	if (_elm_lang$core$Native_Utils.eq(model.name, _elm_lang$core$Maybe$Nothing)) {
		...
		if (_p4.ctor === 'Nothing') {
			...
			if (_p5.ctor === 'Nothing') {
				...
				var phxCmd = _p6._1;
				return A2(_elm_lang$core$Platform_Cmd$map, _user$project$Login$PhoenixMsg, phxCmd);
			}
		}
	}
};
var _user$project$Login$connectSocket = function (model) {
	var channelID = A2(
		_elm_lang$core$Basics_ops['++'],
		'game:',
	...
	var channel = A2(
		...
		_elm_lang$core$Basics$always(
			_user$project$Login$ShowLeaveMessage(channelID)),
		A2(
			_fbonetti$elm_phoenix_socket$Phoenix_Channel$onJoin,
			_elm_lang$core$Basics$always(
				_user$project$Login$ShowJoinMessage(channelID)),
			A2(
				_fbonetti$elm_phoenix_socket$Phoenix_Channel$withPayload,
				_user$project$Login$userParams,
	...
	var phxCmd = _p7._1;
	var phxSocketListen = A4(_fbonetti$elm_phoenix_socket$Phoenix_Socket$on, 'play.card', channelID, _user$project$Login$VoteFromServer, phxSocket);
	return {
		ctor: '_Tuple2',
		_0: phxSocketListen,
		_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Login$PhoenixMsg, phxCmd)
	};
};
var _user$project$Login$Playing = {ctor: 'Playing'};
var _user$project$Login$RoomInput = {ctor: 'RoomInput'};
var _user$project$Login$NameInput = {ctor: 'NameInput'};
var _user$project$Login$progressState = function (model) {
	var _p8 = model.state;
	switch (_p8.ctor) {
		case 'NameInput':
			if (_elm_lang$core$Native_Utils.eq(model.name, _elm_lang$core$Maybe$Nothing)) {
				return {ctor: '_Tuple3', _0: _user$project$Login$NameInput, _1: model.phxSocket, _2: _elm_lang$core$Platform_Cmd$none};
			} else {
				if (_elm_lang$core$Native_Utils.eq(model.roomID, _elm_lang$core$Maybe$Nothing)) {
					return {ctor: '_Tuple3', _0: _user$project$Login$RoomInput, _1: model.phxSocket, _2: _elm_lang$core$Platform_Cmd$none};
				} else {
					var _p9 = _user$project$Login$connectSocket(model);
					var socket = _p9._0;
					var cmd = _p9._1;
					return {ctor: '_Tuple3', _0: _user$project$Login$Playing, _1: socket, _2: cmd};
				}
			}
		case 'RoomInput':
			if (_elm_lang$core$Native_Utils.eq(model.roomID, _elm_lang$core$Maybe$Nothing)) {
				...
				var _p10 = _user$project$Login$connectSocket(model);
				var socket = _p10._0;
				var cmd = _p10._1;
				return {ctor: '_Tuple3', _0: _user$project$Login$Playing, _1: socket, _2: cmd};
			}
		default:
			var _p11 = _user$project$Login$connectSocket(model);
			var socket = _p11._0;
			var cmd = _p11._1;
			return {ctor: '_Tuple3', _0: _user$project$Login$Playing, _1: socket, _2: cmd};
	}
};
var _user$project$Login$init = function (location) {
	var initsocket = A4(
		_fbonetti$elm_phoenix_socket$Phoenix_Socket$on,
		'list',
		'game:*',
		_user$project$Login$ListUpdate,
		_fbonetti$elm_phoenix_socket$Phoenix_Socket$withDebug(
			_fbonetti$elm_phoenix_socket$Phoenix_Socket$init(
				_user$project$Login$socketServer(location))));
	var _p12 = _user$project$Login$getIdFrom(location.search);
	var name = _p12._0;
	var id = _p12._1;
	var model = {
		...
		name: name,
		votes: {ctor: '[]'},
		state: _user$project$Login$NameInput
	};
	var _p13 = _user$project$Login$progressState(model);
...
var _user$project$Login$update = F2(
	function (msg, model) {
		...
		switch (_p15.ctor) {
			...
			case 'JoinRoom':
				var _p17 = _user$project$Login$progressState(model);
			...
			case 'NewRoom':
				...
				var _p18 = A2(_user$project$Login$update, _user$project$Login$JoinRoom, newModel);
			...
			case 'Play':
				...
				return {
					ctor: '_Tuple2',
					_0: newmodel,
					_1: _user$project$Login$play(newmodel)
				};
			case 'VoteFromServer':
				var _p23 = _p15._0;
				var votes = function () {
					var _p20 = A2(_elm_lang$core$Json_Decode$decodeValue, _user$project$Login$decodeVote, _p23);
					if (_p20.ctor === 'Ok') {
						var _p21 = _p20._0;
						return {
							ctor: '::',
							...
							_1: A2(
								...
								_user$project$Login$notUser(_p21.user),
								model.votes)
						};
					} else {
						return model.votes;
				...
				return A2(
					...
					{ctor: '[]'});
			case 'SetName':
				var _p24 = _user$project$Login$progressState(model);
...
var _user$project$Login$main = A2(
	_elm_lang$navigation$Navigation$program,
	_user$project$Login$UrlChange,

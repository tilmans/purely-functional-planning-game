...
var _user$project$Play$extract = F3(
...
var _user$project$Play$notUser = F2(
	function (user, vote) {
		return !_elm_lang$core$Native_Utils.eq(vote.user, user);
	});
var _user$project$Play$getIdFrom = function (location) {
	var string = A2(_elm_lang$core$String$dropLeft, 1, location);
	var subs = A2(_elm_lang$core$String$split, '&', string);
	var name = A3(
		_elm_lang$core$List$foldr,
		_user$project$Play$extract('name'),
		_elm_lang$core$Maybe$Nothing,
		subs);
	var id = A3(
		_elm_lang$core$List$foldr,
		_user$project$Play$extract('room'),
		_elm_lang$core$Maybe$Nothing,
		subs);
	return {ctor: '_Tuple2', _0: name, _1: id};
};
var _user$project$Play$userParams = _elm_lang$core$Json_Encode$object(
	{
		ctor: '::',
		_0: {
			ctor: '_Tuple2',
...
var _user$project$Play$vote = function (vote) {
	return A2(
...
var _user$project$Play$playedCards = function (model) {
	var _p0 = model.votes;
	if (_p0.ctor === '[]') {
		return A2(
			_elm_lang$html$Html$div,
		...
		return A2(
			...
			A2(_elm_lang$core$List$map, _user$project$Play$vote, model.votes));
	}
};
var _user$project$Play$cards = {
	ctor: '::',
	_0: 0,
	_1: {
		ctor: '::',
...
var _user$project$Play$socketServer = function (location) {
...
var _user$project$Play$Vote = F2(
	function (a, b) {
		return {user: a, vote: b};
	});
var _user$project$Play$decodeVote = A3(
	_elm_lang$core$Json_Decode$map2,
	_user$project$Play$Vote,
...
var _user$project$Play$Model = F8(
	function (a, b, c, d, e, f, g, h) {
		return {phxSocket: a, message: b, channel: c, roomID: d, played: e, name: f, votes: g, state: h};
	});
var _user$project$Play$CardSelected = function (a) {
	return {ctor: 'CardSelected', _0: a};
};
var _user$project$Play$cardImage = F3(
				...
				_1: {
					...
					_1: {
						...
						_0: _elm_lang$html$Html_Events$onClick(
							_user$project$Play$CardSelected(number)),
						_1: {ctor: '[]'}
					}
				}
			},
...
var _user$project$Play$aframeScene = function (model) {
	return A2(
		...
		A2(
			...
			A2(
				_elm_lang$core$Basics_ops['++'],
				A2(_elm_lang$core$List$map, _user$project$Play$cardAssets, _user$project$Play$cards),
				A2(
					_elm_lang$core$List$indexedMap,
					_user$project$Play$cardImage(model.played),
					_user$project$Play$cards))));
};
var _user$project$Play$ListUpdate = function (a) {
	return {ctor: 'ListUpdate', _0: a};
};
var _user$project$Play$SetName = {ctor: 'SetName'};
var _user$project$Play$UrlChange = function (a) {
	return {ctor: 'UrlChange', _0: a};
};
var _user$project$Play$NameChange = function (a) {
	return {ctor: 'NameChange', _0: a};
};
var _user$project$Play$nameform = function (model) {
	return A2(
		_elm_lang$html$Html$form,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Events$onSubmit(_user$project$Play$SetName),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				_elm_lang$html$Html$input,
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onInput(_user$project$Play$NameChange),
						_1: {
							ctor: '::',
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(_user$project$Play$SetName),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
...
var _user$project$Play$Play = function (a) {
	return {ctor: 'Play', _0: a};
};
var _user$project$Play$card = function (number) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			...
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onClick(
					_user$project$Play$Play(number)),
				_1: {ctor: '[]'}
			}
		},
		{
...
var _user$project$Play$availableCards = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
	...
	A2(_elm_lang$core$List$map, _user$project$Play$card, _user$project$Play$cards));
var _user$project$Play$gameform = function (model) {
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$href(gameurl),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Link to room'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{ctor: '[]'},
					{
						...
						_1: {
							ctor: '::',
							_0: _user$project$Play$playedCards(model),
							_1: {ctor: '[]'}
						}
					}),
				_1: {
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_1: {
								ctor: '::',
								_0: _user$project$Play$availableCards,
								_1: {ctor: '[]'}
							}
						}),
					_1: {ctor: '[]'}
...
var _user$project$Play$NewRoom = function (a) {
	return {ctor: 'NewRoom', _0: a};
};
var _user$project$Play$RoomIDChanged = function (a) {
	return {ctor: 'RoomIDChanged', _0: a};
};
var _user$project$Play$CreateRoom = {ctor: 'CreateRoom'};
var _user$project$Play$JoinRoom = {ctor: 'JoinRoom'};
var _user$project$Play$startform = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						_elm_lang$html$Html$input,
						{
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onInput(_user$project$Play$RoomIDChanged),
								_1: {ctor: '[]'}
							}
						},
						{ctor: '[]'}),
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(_user$project$Play$JoinRoom),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
				...
				_0: A2(
					...
					{ctor: '[]'},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(_user$project$Play$CreateRoom),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
...
var _user$project$Play$view = function (model) {
	var _p3 = model.state;
	switch (_p3.ctor) {
		case 'NameInput':
			return _user$project$Play$nameform(model);
		case 'RoomInput':
			return _user$project$Play$startform(model);
		default:
			return _user$project$Play$aframeScene(model);
	}
};
var _user$project$Play$VoteFromServer = function (a) {
	return {ctor: 'VoteFromServer', _0: a};
};
var _user$project$Play$ShowJoinMessage = function (a) {
	return {ctor: 'ShowJoinMessage', _0: a};
};
var _user$project$Play$ShowLeaveMessage = function (a) {
	return {ctor: 'ShowLeaveMessage', _0: a};
};
var _user$project$Play$PhoenixMsg = function (a) {
	return {ctor: 'PhoenixMsg', _0: a};
};
var _user$project$Play$subscriptions = function (model) {
	return A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$listen, model.phxSocket, _user$project$Play$PhoenixMsg);
};
var _user$project$Play$play = function (model) {
	if (_elm_lang$core$Native_Utils.eq(model.name, _elm_lang$core$Maybe$Nothing)) {
		...
		if (_p4.ctor === 'Nothing') {
			...
			if (_p5.ctor === 'Nothing') {
				...
				var phxCmd = _p6._1;
				return A2(_elm_lang$core$Platform_Cmd$map, _user$project$Play$PhoenixMsg, phxCmd);
			}
		}
	}
};
var _user$project$Play$connectSocket = function (model) {
	var channelID = A2(
		_elm_lang$core$Basics_ops['++'],
		'game:',
	...
	var channel = A2(
		...
		_elm_lang$core$Basics$always(
			_user$project$Play$ShowLeaveMessage(channelID)),
		A2(
			_fbonetti$elm_phoenix_socket$Phoenix_Channel$onJoin,
			_elm_lang$core$Basics$always(
				_user$project$Play$ShowJoinMessage(channelID)),
			A2(
				_fbonetti$elm_phoenix_socket$Phoenix_Channel$withPayload,
				_user$project$Play$userParams,
	...
	var phxCmd = _p7._1;
	var phxSocketListen = A4(_fbonetti$elm_phoenix_socket$Phoenix_Socket$on, 'play.card', channelID, _user$project$Play$VoteFromServer, phxSocket);
	return {
		ctor: '_Tuple2',
		_0: phxSocketListen,
		_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Play$PhoenixMsg, phxCmd)
	};
};
var _user$project$Play$Playing = {ctor: 'Playing'};
var _user$project$Play$RoomInput = {ctor: 'RoomInput'};
var _user$project$Play$NameInput = {ctor: 'NameInput'};
var _user$project$Play$progressState = function (model) {
	var _p8 = model.state;
	switch (_p8.ctor) {
		case 'NameInput':
			if (_elm_lang$core$Native_Utils.eq(model.name, _elm_lang$core$Maybe$Nothing)) {
				return {ctor: '_Tuple3', _0: _user$project$Play$NameInput, _1: model.phxSocket, _2: _elm_lang$core$Platform_Cmd$none};
			} else {
				if (_elm_lang$core$Native_Utils.eq(model.roomID, _elm_lang$core$Maybe$Nothing)) {
					return {ctor: '_Tuple3', _0: _user$project$Play$RoomInput, _1: model.phxSocket, _2: _elm_lang$core$Platform_Cmd$none};
				} else {
					var _p9 = _user$project$Play$connectSocket(model);
					var socket = _p9._0;
					var cmd = _p9._1;
					return {ctor: '_Tuple3', _0: _user$project$Play$Playing, _1: socket, _2: cmd};
				}
			}
		case 'RoomInput':
			if (_elm_lang$core$Native_Utils.eq(model.roomID, _elm_lang$core$Maybe$Nothing)) {
				...
				var _p10 = _user$project$Play$connectSocket(model);
				var socket = _p10._0;
				var cmd = _p10._1;
				return {ctor: '_Tuple3', _0: _user$project$Play$Playing, _1: socket, _2: cmd};
			}
		default:
			var _p11 = _user$project$Play$connectSocket(model);
			var socket = _p11._0;
			var cmd = _p11._1;
			return {ctor: '_Tuple3', _0: _user$project$Play$Playing, _1: socket, _2: cmd};
	}
};
var _user$project$Play$init = function (location) {
	var initsocket = A4(
		_fbonetti$elm_phoenix_socket$Phoenix_Socket$on,
		'list',
		'game:*',
		_user$project$Play$ListUpdate,
		_fbonetti$elm_phoenix_socket$Phoenix_Socket$withDebug(
			_fbonetti$elm_phoenix_socket$Phoenix_Socket$init(
				_user$project$Play$socketServer(location))));
	var _p12 = _user$project$Play$getIdFrom(location.search);
	var name = _p12._0;
	var id = _p12._1;
	var model = {
		...
		name: name,
		votes: {ctor: '[]'},
		state: _user$project$Play$NameInput
	};
	var _p13 = _user$project$Play$progressState(model);
...
var _user$project$Play$update = F2(
	function (msg, model) {
		...
		switch (_p15.ctor) {
			...
			case 'JoinRoom':
				var _p17 = _user$project$Play$progressState(model);
			...
			case 'NewRoom':
				...
				var _p18 = A2(_user$project$Play$update, _user$project$Play$JoinRoom, newModel);
			...
			case 'Play':
				...
				return {
					ctor: '_Tuple2',
					_0: newmodel,
					_1: _user$project$Play$play(newmodel)
				};
			case 'VoteFromServer':
				var _p23 = _p15._0;
				var votes = function () {
					var _p20 = A2(_elm_lang$core$Json_Decode$decodeValue, _user$project$Play$decodeVote, _p23);
					if (_p20.ctor === 'Ok') {
						var _p21 = _p20._0;
						return {
							ctor: '::',
							...
							_1: A2(
								...
								_user$project$Play$notUser(_p21.user),
								model.votes)
						};
					} else {
						return model.votes;
				...
				return A2(
					...
					{ctor: '[]'});
			case 'SetName':
				var _p24 = _user$project$Play$progressState(model);
...
var _user$project$Play$main = A2(
	_elm_lang$navigation$Navigation$program,
	_user$project$Play$UrlChange,
	{init: _user$project$Play$init, view: _user$project$Play$view, update: _user$project$Play$update, subscriptions: _user$project$Play$subscriptions})();

var Elm = {};
Elm['Play'] = Elm['Play'] || {};
if (typeof _user$project$Play$main !== 'undefined') {
    _user$project$Play$main(Elm['Play'], 'Play', {"types":{"unions":{"Json.Encode.Value":{"args":[],"tags":{"Value":[]}},"Play.Msg":{"args":[],"tags":{"Play":["Int"],"CardSelected":["Int"],"JoinRoom":[],"ShowLeaveMessage":["String"],"NameChange":["String"],"PhoenixMsg":["Phoenix.Socket.Msg Play.Msg"],"ShowJoinMessage":["String"],"UrlChange":["Navigation.Location"],"SetName":[],"RoomIDChanged":["String"],"ListUpdate":["Json.Encode.Value"],"VoteFromServer":["Json.Encode.Value"],"NewRoom":["Int"],"CreateRoom":[]}},"Phoenix.Socket.Msg":{"args":["msg"],"tags":{"ChannelErrored":["String"],"ChannelClosed":["String"],"ExternalMsg":["msg"],"ChannelJoined":["String"],"Heartbeat":["Time.Time"],"NoOp":[],"ReceiveReply":["String","Int"]}}},"aliases":{"Time.Time":{"args":[],"type":"Float"},"Navigation.Location":{"args":[],"type":"{ href : String , host : String , hostname : String , protocol : String , origin : String , port_ : String , pathname : String , search : String , hash : String , username : String , password : String }"}},"message":"Play.Msg"},"versions":{"elm":"0.18.0"}});
}
